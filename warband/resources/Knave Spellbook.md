1. adhere: Objects become sticky enough to hold a PC to a ceiling. Lasts until washed.
2. animal friendship: Animals obey your orders as well as a trained dog for one day.
3. animate object: Objects obey your orders. They move 15’ per round.
4. anthropomorphize: Animals gain human intelligence for one day.
...
23. displace: An object appears to be up to INT × 10’ from its actual position.23
...
29. fog cloud: Fog spreads out in an INT × 10’ radius from you. Fades in one turn.
...
54. ooze form: Your body and gear become living slime for INT turns.24
...
68. shroud: INT creatures are invisible for as long as they can hold their breath
...
, producing a thousand cubic feet of water per turn for INT turns.
...
99. wizard mark: Your finger produces ulfire-colored paint for INT hours. This paint is only visible to you, and can be seen at any distance, even through objects.
100. x-ray vision: You can see through INT feet of material.